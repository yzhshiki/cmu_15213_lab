...
int floatFloat2Int(unsigned uf) {
  int s_ = uf>>31;
  int exp_ = ((0x7f800000 & uf)>>23)-127;
  int frac_ = (uf & 0x007fffff)|0x00800000;
  if(!(uf&0x7fffffff)) return 0;  //uf==0, return 0
  
  if(exp_ > 31) return 0x80000000u;
  if(exp_ < 0) return 0;
